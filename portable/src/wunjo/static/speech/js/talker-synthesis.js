        ...
        .then(data => {
          ...
          if (data.status_code === 200) {
           ...
           if (audioTalkerSrc) {
            ...
            // advanced settings
            var expressionScaleTalker = elem.querySelector('#expression-scale-talker');
            var inputYawTalker = elem.querySelector('#input-yaw-talker');
            var inputPitchTalker = elem.querySelector('#input-pitch-talker');
            var inputRollTalker = elem.querySelector('#input-roll-talker');
            var backgroundEnhancerTalker = elem.querySelector('#background-enhancer-talker');
            ...
            if (mediaName && audioName && canvasRectanglesList.length > 0) {
                ...
                var predictParametersTalker = {
                    ...
                    "still": still.checked,
                    "enhancer": enhancer,
                    "expression_scale": expressionScaleTalker.value,
                    "input_yaw": inputYawTalker.value,
                    "input_pitch": inputPitchTalker.value,
                    "input_roll": inputRollTalker.value,
                    "background_enhancer": backgroundEnhancerTalker.checked,
                };
        ...
        steps: [
            {
                ...
                intro: `
                    ...
                    <div style="width: 200pt;">
                        ...
                        <fieldset style="margin-top:10pt;padding: 5pt;border-color: rgb(255 255 255 / 0%);">
                          ...
                          <div id="advanced-settings" style="display:none;">
                            <div style="justify-content: space-between;padding: 5pt; display: flex;">
                              <label for="expression-scale-talker">Выраженность мимики</label>
                              <input type="number" title="Введите число" id="expression-scale-talker" name="expression-scale" min="0.5" max="1.5" step="0.05" value="1.0" style="border-width: 2px;border-style: groove;border-color: rgb(192, 192, 192);background-color: #fff;padding: 1pt;width: 30pt;">
                            </div>
                            <div style="padding: 5pt;">
                              <label for="input-yaw-talker">Угол поворота по XY</label>
                              <input type="text" pattern="[0-9,]+" oninput="this.value = this.value.replace(/[^0-9,-]/g, '');" title="Введите числа через запятую" id="input-yaw-talker" name="input-yaw" style="width: 100%;border-width: 2px;border-style: groove;border-color: rgb(192, 192, 192);background-color: #fff;padding: 1pt;">
                            </div>
                            <div style="padding: 5pt;">
                              <label for="input-pitch-talker">Угол поворота по YZ</label>
                              <input type="text" pattern="[0-9,]+" oninput="this.value = this.value.replace(/[^0-9,-]/g, '');" title="Введите числа через запятую" id="input-pitch-talker" name="input-pitch" style="width: 100%;border-width: 2px;border-style: groove;border-color: rgb(192, 192, 192);background-color: #fff;padding: 1pt;">
                            </div>
                            <div style="padding: 5pt;">
                              <label for="input-roll-talker">Угол поворота по ZX</label>
                              <input type="text" pattern="[0-9,]+" oninput="this.value = this.value.replace(/[^0-9,-]/g, '');" title="Введите числа через запятую" id="input-roll-talker" name="input-roll" style="width: 100%;border-width: 2px;border-style: groove;border-color: rgb(192, 192, 192);background-color: #fff;padding: 1pt;">
                            </div>
                            <div style="padding: 5pt;display:none;">
                              <input type="checkbox" id="background-enhancer-talker" name="background-enhancer">
                              <label for="background-enhancer-talker">Улучшение фона (долго)</label>
                            </div>
                        ...
                        <button class="introjs-button" style="background: #f7db4d;margin-top: 10pt;text-align: center;width: 100%;padding-right: 0 !important;padding-left: 0 !important;padding-bottom: 0.5rem !important;padding-top: 0.5rem !important;" onclick="sendDataToTalker(this.parentElement.parentElement);">Синтезировать видео</button>
                    </div>
                    </div>
                    `,
            }
