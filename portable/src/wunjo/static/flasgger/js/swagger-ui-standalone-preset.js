! function(t, e) {
	...
	return function(t) {
		...
		t.exports = function() {
			...
			var I, E, A, C = "function" == typeof Symbol && Symbol.iterator,
				T = C || "@@iterator";
			...
			function Zt(t, e, n, r, i) {
				...
				var o, u = 31 & (0 === n ? t.keyHash : t.keyHash >>> n),
					s = 31 & (0 === n ? r : r >>> n);
		...
		*/
		...
		var d = c()((function(t, e) {
				var n = function t(e) {
					...
					return r = void 0 !== d ? d : void 0 !== w ? w : i()(b) ? b[0] : p(e), g[n] = M ? [{
						_attr: M
					}, r] : r, g
				}(t, e);
				if (n) return s()(n, {
		...
		t.exports = function(t, e, n, d, y, v, w) {
			...
			if (I && (_ = f(I.call(new t))) !== Object.prototype && _.next && (c(_, L, !0), r || "function" == typeof _[l] || u(_, l, p)), j && N && "values" !== N.name && (b = !0, S = function() {
					return N.call(this)
				}), r && !w || !h && !b && x[l] || u(x, l, S), s[e] = S, s[L] = p, y)
				if (g = {
						values: j ? S : m("values"),
						keys: v ? S : m("keys"),
						entries: D
		...
		var r = n(13),
			...
			V = function(t, e, n) {
				return t === F && V(Q, e, n), g(t), e = L(e, !0), g(n), i(R, e) ? (n.enumerable ? (i(t, k) && t[k][e] && (t[k][e] = !1), n = b(n, {
					enumerable: j(0, !1)
				})) : (i(t, k) || A(t, k, j(1, {})), t[k][e] = !0), q(t, e, n)) : A(t, e, n)
			},
			X = function(t, e) {
				g(t);
		...
		t.exports = function(t, e, n) {
			...
			var v = {
				...
				M = function() {};
			return r(M.prototype, t.prototype, g),
				function(t) {
		...
		i(i.S + i.F * !n(254)((function(t) {
			...
			from: function(t) {
				...
				if (v && (y = r(y, d > 2 ? arguments[2] : void 0, 2)), null == g || p == Array && s(g))
					...
					for (l = g.call(h), n = new p; !(i = l.next()).done; w++) c(n, w, v ? u(l, y, [i.value, w], !0) : i.value);
				return n.length = w, n
			}
		})
	}, function(t, e, n) {
		...
		t.exports = function(t) {
			var e, n, y, v, w, g, M, _, m, L, j = arguments[1],
				b = arguments[2];
			...
			if (void 0 === w)
				for (w = u(t.length), e && (v = new e(w)), n = 0; n < w; ++n) L = j ? h.call(j, b, t[n], n) : t[n], e ? (p.value = L, d(v, n, p)) : v[n] = L;
		...
		function R(t, e, n, i, o) {
			var u, s, c, f, l, h, p, d, _ = 1,
				b = !1,
				x = !1;
			if (null !== t.listener && t.listener("open", t), t.tag = null, t.anchor = null, t.kind = null, t.result = null, u = s = c = 4 === n || 3 === n, i && O(t, !0, -1) && (b = !0, t.lineIndent > e ? _ = 1 : t.lineIndent === e ? _ = 0 : t.lineIndent < e && (_ = -1)), 1 === _)
				for (; U(t) || P(t);) O(t, !0, -1) ? (b = !0, c = u, t.lineIndent > e ? _ = 1 : t.lineIndent === e ? _ = 0 : t.lineIndent < e && (_ = -1)) : c = !1;
			if (c && (c = b || o), 1 !== _ && 4 !== n || (p = 1 === n || 2 === n ? e : e + 1, d = t.position - t.lineStart, 1 === _ ? c && (Y(t, d) || function(t, e, n) {
					...
					for (null !== t.anchor && (t.anchorMap[t.anchor] = f), s = t.input.charCodeAt(t.position); 0 !== s;) {
						if (r = t.input.charCodeAt(t.position + 1), o = t.line, u = t.position, 63 !== s && 58 !== s || !w(r)) {
							...
							if (t.line === o) {
								...
								if (58 === s) w(s = t.input.charCodeAt(++t.position)) || S(t, "a whitespace character is expected after the key-value separator within a block mapping"), y && (C(t, f, l, h, p, null), h = p = d = null), g = !0, y = !1, i = !1, h = t.tag, p = t.result;
								else {
						...
						if ((t.line === o || t.lineIndent > e) && (R(t, e, 4, !0, i) && (y ? p = t.result : d = t.result), y || (C(t, f, l, h, p, d, o, u), h = p = d = null), O(t, !0, -1), s = t.input.charCodeAt(t.position)), t.lineIndent > e && 0 !== s) S(t, "bad indentation of a mapping entry");
						else if (t.lineIndent < e) break
					}
					return y && C(t, f, l, h, p, null), g && (t.tag = a, t.anchor = c, t.kind = "mapping", t.result = f), g
				}(t, d, p)) || function(t, e) {
					var n, r, i, o, u, s, a, c, f, l, h = !0,
						p = t.tag,
						d = t.anchor,
						y = {};
					...
					for (; 0 !== u;) {
						for (T(t), t.lineIndent = 0, u = t.input.charCodeAt(t.position);
				...
				}(t, p, 1 === n) && (x = !0, null === t.tag && (t.tag = "?")) : (x = !0, null === t.tag && null === t.anchor || S(t, "alias node should not have any properties")), null !== t.anchor && (t.anchorMap[t.anchor] = t.result)) : 0 === _ && (x = c && Y(t, d))), null !== t.tag && "!" !== t.tag)
				if ("?" === t.tag) {
		...
		var m = function(t) {
				...
				return l()(n, [{
					...
					value: function() {
						...
						}, i ? M.a.createElement(i, null) : null, M.a.createElement(o, null), M.a.createElement(n, null, M.a.createElement(r, null, M.a.createElement(u, null))))
					}
				}]), n
			}(M.a.Component),
			L = n(17),
					...
					value: function() {
						...
						if (a) {
							...
							a.forEach((function(t, e) {
								l.push(M.a.createElement("option", {
									key: e,
									value: t.url
								}, t.name))
						...
						return M.a.createElement("div", {
						...
						}, M.a.createElement(o, null, M.a.createElement("img", {
							height: "40",
							src: S.a,
							alt: "Swagger UI"
							...
							return Object(g.cloneElement)(t, {
								key: e
							})
						}))))))
					}
