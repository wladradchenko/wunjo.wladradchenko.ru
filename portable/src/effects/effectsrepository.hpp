...
public:
    ...
    /** @brief Forget an effect whose XML file is already gone — the plugin that
     *  brought it was uninstalled and took the file with it */
    void unregisterEffect(const QString &id);
