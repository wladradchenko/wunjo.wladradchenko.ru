...
public:
    ...
    */
    bool selectCurrentItem(WunjoObjectType type, bool select, bool addToCurrent = false, bool showErrorMsg = true);
    ...
    */
    ...
    /** @brief Open Wunjo's config diablog on a defined page and tab
     */
