        ...
        delegate: Item {
            ...
            Loader {
                ...
                sourceComponent: Clip {
                    // -4 leaves a gap at the track bottom matching the rounded lane background
                    // inset, so clips read as rounded cards separated from adjacent tracks.
                    height: trackRoot.height - 4
