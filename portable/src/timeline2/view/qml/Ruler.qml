...
Item {
    ...
    property int guideLabelHeight: K.WunjoSettings.showmarkers ? fontMetrics.height : 0
    ...
    Repeater {
        ...
        property int radiusSize: K.WunjoSettings.lockedGuides ? 0 : rulerRoot.guideLabelHeight / 2
        delegate:
        Item {
            id: guideRoot
            anchors.fill: parent
            ...
            Rectangle {
                ...
                Rectangle {
                    visible: K.WunjoSettings.showmarkers && width < parent.width
                    ...
                    Rectangle {
                        visible: !K.WunjoSettings.lockedGuides
                        color: guideRoot.model.color
                        anchors.fill: parent
            ...
            Rectangle {
                ...
                visible: !guideRoot.isRangeMarker || K.WunjoSettings.showmarkers
                
                Rectangle {
                    visible: K.WunjoSettings.showmarkers && !guideRoot.isRangeMarker
