...
Rectangle {
    ...
    Rectangle {
        ...
        width: 2
        color: (typeof wunjoTheme !== 'undefined' && wunjoTheme) ? wunjoTheme.accent : '#C8EDD2'
        opacity: 0.5
    }
    Rectangle {
    ...
    Rectangle {
        ...
        height: parent.height
        width: height
        color: moveMouseArea.containsMouse || moveMouseArea.drag.active ? ((typeof wunjoTheme !== 'undefined' && wunjoTheme) ? wunjoTheme.accent : '#C8EDD2') : 'transparent'
