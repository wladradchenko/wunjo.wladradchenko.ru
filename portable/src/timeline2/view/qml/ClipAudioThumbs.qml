...
Row {
    ...
    function processReload() {
        ...
        if (!waveform.visible || !K.WunjoSettings.audiothumbnails) {
            return
        }
    ...
    Repeater {
        ...
        K.TimelineWaveform {
            ...
            bgColorEven: waveform.parentClip.selected ? waveform.audioColor : waveform.audioColor.darker(1.5) //K.WunjoSettings.thumbColor1.darker(5)
            bgColorOdd: waveform.parentClip.selected ? waveform.audioColor : waveform.audioColor.darker(1.5)//K.WunjoSettings.thumbColor2.darker(5)
            fgColorEven: waveform.parentClip.selected ? K.WunjoSettings.thumbColor1 :  K.WunjoSettings.thumbColor1.darker(1.5)
            fgColorOdd: waveform.parentClip.selected ? K.WunjoSettings.thumbColor2 : K.WunjoSettings.thumbColor2.darker(1.5)
