...
{
    QString fileName = QFileDialog::getOpenFileName(this, i18n("Import Layout"), QString(), i18n("Wunjo Layout (*.json)"));
...
void LayoutManagerDialog::exportLayout()
{
    ...
    QString fileName = UiUtils::getSaveFileName(this, i18n("Export Layout"), layoutId + ".json", i18n("Wunjo Layout (*.json)"), QStringLiteral(".json"));
    if (fileName.isEmpty()) return;
...
void LayoutManagerDialog::updateOrder()
{
    ...
    WunjoSettings::setLayoutsOrder(newOrder);
}
