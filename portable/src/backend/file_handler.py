...
class FileHandler:
    @staticmethod
    def get_synthesized_audio(text, model_type, dir_time, **options):
        try:
            results = FileHandler.get_models_results(text, model_type, dir_time, **options)
    ...
    @staticmethod
    def get_models_results(text, model_type, dir_time, **options):
