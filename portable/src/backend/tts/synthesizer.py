...
class Synthesizer:
    ...
    def load_config(config_source):
        ...
        if not os.path.dirname(os.path.dirname(os.path.abspath(__file__))) in config_source:
            config_source = f"{os.path.dirname(os.path.dirname(os.path.abspath(__file__)))}/{config_source}"
