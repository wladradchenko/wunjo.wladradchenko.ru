    ...
    , m_projectDuration(duration)
{
    ...
    formatEdit->setText(WunjoSettings::exportGuidesFormat().isEmpty() ? defaultFormat : WunjoSettings::exportGuidesFormat());
...
{
    WunjoSettings::setExportGuidesFormat(formatEdit->text());
}
