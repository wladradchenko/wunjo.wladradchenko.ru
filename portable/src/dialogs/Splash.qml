        ...
        Item {
            ...
            Item {
                ...
                Label {
                    ...
                    text: KI18n.i18n("Wunjo crashed on last start. Reset config and restart?")
            ...
            Item {
                ...
                Button {
                    ...
                    onClicked: splash.openLink("https://wunjo.online/news/releases/" + splash.version + "?mtm_campaign=wunjo_inapp&mtm_kwd=splash_upgraded_notes&mtm_content=" + splash.version)
                    KeyNavigation.tab: listView
                }
            }
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Label {
                        ...
                        Layout.fillWidth: true
                        leftPadding: 10
                        text: KI18n.i18n("Help us make Wunjo even better")
                    ...
                    ToolButton {
                        ...
                        enabled: splash.actionsEnabled
                        onClicked: splash.openLink("https://wunjo.online/get-involved?mtm_campaign=wunjo_inapp&mtm_kwd=splash_donatebar_contribute&mtm_content=" + splash.version)
                    }

                    ToolButton {
                        text: KI18n.i18n("Community")
                        icon.name: "donate"
                        enabled: splash.actionsEnabled
                        onClicked: splash.openLink("https://www.patreon.com/wladradchenko")
                        KeyNavigation.tab: listView
                    }
            ...
            ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    Label {
                        ...
                        text: KI18n.i18n("<h3>Welcome to Wunjo Quick Setup</h3>")
                    }

                    Switch {
                        id: themeSwitch
                        visible: false  // Wunjo always uses its own theme; no user choice
