...
void JogManager::slotConfigurationChanged()
{
    ...
    if (WunjoSettings::enableshuttle()) {
        m_shuttle = new JogShuttle(JogShuttle::canonicalDevice(WunjoSettings::shuttledevice()));
        m_shuttleAction = new JogShuttleAction(m_shuttle, JogShuttleConfig::actionMap(WunjoSettings::shuttlebuttons()));
