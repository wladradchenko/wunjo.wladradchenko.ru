...
class AnimateFromCoeff():
    ...
    def generate(self, x, video_save_dir, pic_path, crop_info, enhancer=None, background_enhancer=None, preprocess='crop', pic_path_type="static"):
        ...
        if preprocess.lower() == 'full':
            ...
            new_video_name = paste_pic(video_path=temp_video_file, pic_path=pic_path, crop_info=crop_info, new_audio_path=new_audio_file, video_save_dir=video_save_dir, pic_path_type=pic_path_type)
