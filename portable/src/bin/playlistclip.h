...
/**
 * @class PlaylistClip
 * @brief Represents a Playlist clip (for example a .wmproj file) in the project.
...
public:
    ...
    /**
     * @brief Constructor.
     * @param description element describing the clip; the "wunjo:id" attribute and "resource" property are used
     */
