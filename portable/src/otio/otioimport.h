 ...
 *
 * OTIO markers on the timeline stack are converted to wunjo guides.
 *
 * OTIO markers on clips are converted to wunjo clip markers. Note that
 * clip markers work differently between wunjo and OTIO; in wunjo they
 * are shared between each instance of the clip, in OTIO the they are unique
 * to each instance of the clip.
 *
 * If the OTIO marker metadata does not contain the wunjo marker type,
 * we pick the wunjo guide/marker with the closest color to the OTIO
 * marker.
 */
