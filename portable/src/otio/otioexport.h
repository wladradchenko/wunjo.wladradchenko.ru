 ...
 * differently between wunjo and OTIO; in wunjo they are shared
 * between each instance of the clip, in OTIO the they are unique to each
 * instance of the clip.
 *
 * The wunjo marker types are stored as OTIO metadata for round-tripping
 * files. This allows the guides and clip markers to be properly recreated
 * when importing an OTIO file that was created with wunjo. The metadata
 * is stored under the key "wunjo" to keep it separate from metadata of
 * other applications.
 */
