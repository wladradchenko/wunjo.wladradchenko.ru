...
def histogram_transform(img: np.ndarray, means: np.ndarray, stds: np.ndarray, target_means: np.ndarray, target_stds: np.ndarray):
...
def blend(a: np.ndarray, b: np.ndarray,  min_error: np.ndarray, weight1=0.5, weight2=0.5):
