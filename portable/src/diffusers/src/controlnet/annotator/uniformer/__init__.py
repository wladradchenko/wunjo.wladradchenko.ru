...
from diffusers.src.controlnet.annotator.uniformer.mmseg.apis import init_segmentor, inference_segmentor, show_result_pyplot
from diffusers.src.controlnet.annotator.uniformer.mmseg.core.evaluation import get_palette
from diffusers.src.controlnet.annotator.util import annotator_ckpts_path
