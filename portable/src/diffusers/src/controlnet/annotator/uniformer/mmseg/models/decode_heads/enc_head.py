...
from diffusers.src.controlnet.annotator.uniformer.mmcv.cnn import ConvModule, build_norm_layer

from diffusers.src.controlnet.annotator.uniformer.mmseg.ops import Encoding, resize
