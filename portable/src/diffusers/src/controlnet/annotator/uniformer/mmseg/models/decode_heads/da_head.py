...
from diffusers.src.controlnet.annotator.uniformer.mmcv.cnn import ConvModule, Scale
from torch import nn

from diffusers.src.controlnet.annotator.uniformer.mmseg.core import add_prefix
