...
from diffusers.src.controlnet.annotator.uniformer.mmcv.cnn import ConvModule, normal_init
from diffusers.src.controlnet.annotator.uniformer.mmcv.ops import point_sample

from diffusers.src.controlnet.annotator.uniformer.mmseg.models.builder import HEADS
