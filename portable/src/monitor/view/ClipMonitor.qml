...
Item {
    ...
    Component.onCompleted: {
        ...
        if (K.WunjoSettings.alwaysShowMonitorAudio && audioView.visible) {
    ...
    Item {
        ...
        Item {
            ...
            // Face detection boxes are drawn in the Project Monitor only, where
            // the clip is seen in context (see ProjectMonitor.qml).
        ...
        Item {
            ...
            AudioView {
                ...
                visible: isAudioClip || ((K.WunjoSettings.alwaysShowMonitorAudio || root.showAudiothumb) && (root.controller.clipType === K.ClipType.AV || root.controller.clipHasAV))
            }
            Menu {
                id: contextMenu
                Instantiator {
        ...
        Rectangle {
            ...
            height: K.UiUtils.baseSizeMedium * 2
            ...
            Rectangle {
                ...
                width: height
                radius: 4
                color: Qt.rgba(activePalette.window.r, activePalette.window.g, activePalette.window.b, 0.9)
                border.width: 1
            ...
            Row {
                Item {
                    ...
                    Image {
                        ...
                        source: "image://icon/wunjo-show-video"
                        // ask the icon provider for the display size, otherwise
                        // it returns a small pixmap that gets upscaled (blurry)
