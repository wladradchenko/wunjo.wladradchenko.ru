...
Rectangle {
    ...
    MouseArea {
        ...
        onPositionChanged: mouse => {
            ...
            var snappedFrame = K.WunjoSettings.showMonitorGrid ? 
                SnappingLogic.getSnappedResizeRect(adjustedFrame, handle.rotationAngle, handle.handleType, K.WunjoSettings.monitorGridH, K.WunjoSettings.monitorGridV) :
                adjustedFrame

            handle.resize(snappedFrame)
            
            if (!handle.isKeyframe && K.WunjoSettings.autoKeyframe) {
