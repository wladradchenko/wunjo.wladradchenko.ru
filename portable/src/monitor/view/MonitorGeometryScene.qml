...
Item {
    ...
    property bool showHandles: (controller.isKeyframe || K.WunjoSettings.autoKeyframe) && !disableHandles
    ...
    function getSnappedRect(frameRect, rotationAngle) {
      ...
      return SnappingLogic.getSnappedRect(frameRect, rotationAngle, K.WunjoSettings.monitorGridH, K.WunjoSettings.monitorGridV)
    }
    ...
    Rectangle {
        ...
        enabled: root.controller.isKeyframe || K.WunjoSettings.autoKeyframe
        color: "transparent"
        border.color: root.disableHandles ? 'transparent' : "#ff0000"
