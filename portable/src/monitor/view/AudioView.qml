...
Item {
    ...
    property bool alwaysShowMonitorAudio: K.WunjoSettings.alwaysShowMonitorAudio
    ...
    onDragButtonsVisibleChanged: {
        if (!K.WunjoSettings.alwaysShowMonitorAudio) {
    ...
    function refreshView()
    {
        ...
        audioThumb.stateVisible = (monitorController.clipHasAV && (K.WunjoSettings.alwaysShowMonitorAudio || thumbTimer.running)) || audioThumb.isAudioClip
    ...
    Item {
        ...
        Rectangle {
            ...
            id: audioBg
            color: Utils.mixColors(activePalette.base, K.WunjoSettings.thumbColor1, 0.3)
            opacity: audioThumb.isAudioClip || K.WunjoSettings.alwaysShowMonitorAudio ? 1 : 0.6
            anchors.fill: parent
        }
        Repeater {
            id: streamThumb
            ...
            Item {
                ...
                Repeater {
                    ...
                    Rectangle {
                        ...
                        color: index %2 == 0 ? K.WunjoSettings.thumbColor1 : K.WunjoSettings.thumbColor2
                    }
                }
                ...
                Rectangle {
                    ...
                    color:  Utils.mixColors(K.WunjoSettings.thumbColor1, activePalette.highlight, 0.6)
                ...
                K.TimelineWaveform {
                    ...
                    normalize: K.WunjoSettings.normalizechannels
                    ...
                    fgColorEven: "#00000000" //K.WunjoSettings.thumbColor1
                    fgColorOdd: "#00000000" //K.WunjoSettings.thumbColor2
                    ...
                    Repeater {
                        ...
                        Item {
                            ...
                            Rectangle {
                                width: parent.width
                                y: K.WunjoSettings.displayallchannels ? channelCenterLines.index * streamContainer.channelHeight + streamContainer.channelHeight / 2 - 0.5 : streamContainer.height / 2 - 0.5
                                height: 1
                                opacity: 0.4
                                color: audioBg.color
                            }
                            ...
                            Rectangle {
                                ...
                                visible: channelCenterLines.index > 0 && K.WunjoSettings.displayallchannels
    ...
    Rectangle {
        ...
        // sit at the top edge of the audio strip, right below the
        // "drag to add only video/audio" buttons
        anchors.left: parent.left
        anchors.top: parent.top
        ...
        height: width
        radius: 4
        color: audioRefresh.hovered ? Qt.rgba(activePalette.window.r, activePalette.window.g, activePalette.window.b, 0.9) : Qt.rgba(activePalette.base.r, activePalette.base.g, activePalette.base.b, 0.5)
        border.width: 1
        border.color: audioRefresh.hovered ? activePalette.highlight : "transparent"
        K.MonitorToolButton {
            id: audioRefresh
            anchors.centerIn: parent
            // icon proportions matching the drag-zone buttons above
            icon.width: Math.round(parent.width * 0.6)
            icon.height: Math.round(parent.width * 0.6)
            hoverEnabled: true
