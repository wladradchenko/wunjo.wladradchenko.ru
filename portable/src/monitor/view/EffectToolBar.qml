...
MouseArea {
    ...
    Rectangle {
        ...
        Column {
            ...
            K.MonitorToolButton {
                ...
                checkable: true
                checked: K.WunjoSettings.showMonitorGrid
                onClicked: {
            ...
            K.MonitorToolButton {
                ...
                onClicked: { K.WunjoSettings.autoKeyframe = !K.WunjoSettings.autoKeyframe }
                checkable: true
                checked: K.WunjoSettings.autoKeyframe
    ...
    Rectangle {
        ...
        border.color: "#ffffff"
        border.width: 1.5
        visible: K.WunjoSettings.autoKeyframe
        ...
        MouseArea {
            ...
            hoverEnabled: true
            onClicked: {
                K.WunjoSettings.autoKeyframe = false
            }
        }
    }
}
