...
bool QmlManager::setScene(Wunjo::MonitorId id, SceneType::MonitorSceneType type, QSize profile, double profileStretch, int duration)
{
    ...
    case SceneType::MonitorSceneGeometry:
        m_view->setSource(QUrl(QStringLiteral("qrc:/qt/qml/online/wunjo/make/MonitorGeometryScene.qml")));
    ...
    case SceneType::MonitorSceneCorners:
        m_view->setSource(QUrl(QStringLiteral("qrc:/qt/qml/online/wunjo/make/MonitorCornerScene.qml")));
        root = m_view->rootObject();
    ...
    case SceneType::MonitorSceneRoto:
        m_view->setSource(QUrl(QStringLiteral("qrc:/qt/qml/online/wunjo/make/MonitorRotoScene.qml")));
        root = m_view->rootObject();
    ...
    case SceneType::MonitorSplitTrack:
        m_view->setSource(QUrl(QStringLiteral("qrc:/qt/qml/online/wunjo/make/MonitorSplitTracks.qml")));
        root = m_view->rootObject();
    ...
    case SceneType::MonitorSceneSplit:
        m_view->setSource(QUrl(QStringLiteral("qrc:/qt/qml/online/wunjo/make/MonitorSplit.qml")));
        root = m_view->rootObject();
        break;
    case SceneType::MonitorSceneTrimming:
        m_view->setSource(QUrl(QStringLiteral("qrc:/qt/qml/online/wunjo/make/MonitorTrimming.qml")));
        root = m_view->rootObject();
        break;
    case SceneType::MonitorSceneAutoMask:
        m_view->setSource(QUrl(QStringLiteral("qrc:/qt/qml/online/wunjo/make/MonitorAutomask.qml")));
        root = m_view->rootObject();
    ...
    default:
        if (id == Wunjo::ClipMonitor) {
            m_view->setSource(QUrl(QStringLiteral("qrc:/qt/qml/online/wunjo/make/ClipMonitor.qml")));
        } else {
            m_view->setSource(QUrl(QStringLiteral("qrc:/qt/qml/online/wunjo/make/ProjectMonitor.qml")));
        }
        root = m_view->rootObject();
        break;
    }
