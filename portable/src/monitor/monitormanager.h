...
public:
    ...
    */
    AbstractMonitor *monitor(Wunjo::MonitorId monitorName);
    bool isActive(Wunjo::MonitorId id) const;
    ...
    void lockMonitor(Wunjo::MonitorId name, bool);
    void refreshIcons();
    void resetDisplay();
...
public Q_SLOTS:
    ...
    bool activateMonitor(Wunjo::MonitorId name, bool raiseMonitor = true, bool quickSwitch = false);
    void slotPlay();
    void slotPause();
    void slotPlayZone();
    ...
    void markMonitorDirty(Wunjo::MonitorId name, const QUuid uuid);
