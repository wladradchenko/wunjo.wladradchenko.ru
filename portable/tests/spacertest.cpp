...
TEST_CASE("Remove all spaces", "[Spacer]")
{
    ...
    WunjoDoc document(undoStack, {1, 2});
    ...
    QString binId = WunjoTests::createProducer(pCore->getProjectProfile(), "red", binModel, 20);
    QString avBinId = WunjoTests::createProducerWithSound(pCore->getProjectProfile(), binModel, 100);
