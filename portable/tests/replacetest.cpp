...
TEST_CASE("Replace Clip", "[ReplaceClip]")
{
    ...
    QString binId2 = WunjoTests::createProducerWithSound(pCore->getProjectProfile(), binModel, 100);
    QString binId3 = WunjoTests::createProducerWithSound(pCore->getProjectProfile(), binModel, 15);
