...
public:
    ...
    static QDomDocument getDocument(WunjoDoc *openedDoc);
    ...
    static void updateProjectProfile(WunjoDoc *doc, bool reloadProducers = false) { doc->updateProjectProfile(reloadProducers, false); }
};
