"""Hyper-parameters and the bit helpers the signature is written with.

Ported from Wunjo v2 (portable/src/sound_processing/clone_voice/utils.py), with
the sentence splitting left behind: that belonged to the text-to-speech half of
OpenVoice, and this plugin converts a voice rather than reading text.
"""
import json
