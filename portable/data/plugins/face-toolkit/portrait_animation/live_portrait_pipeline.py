...
class LivePortraitPipeline(object):
    ...
    def safety_execute(self, args: ArgumentConfig, progress_callback=None, **kwargs):
        ...
        if source_start != 0:
            for i in tqdm(range(source_start), desc="Extract source...", total=source_start, unit='iB', unit_scale=True, file=sys.stderr):
                # Source
        ...
        for i in tqdm(range(n_frames), desc="Animate...", total=n_frames, unit='iB', unit_scale=True, file=sys.stderr):
            # Source
