...
Обновление 1.5.0
- [ ] Добавить перевод клонирования голоса с кодировщиками на английском, китайском, русском, испанском языках.
- [ ] Добавить хранилище моделей для клонирования голоса на разные языки (или скачивать все модели по умолчанию)
- [ ] Добавить модуль замены лица для дипфейка на видео/фото с одного фото
...
- [ ] Улучшение индикации и перевода текущего прогресса синтеза речи или дипфейка
- [ ] Добавить вкл/выкл для отладки с консолью Python в приложении
- [ ] Изменение перевода в реальном времени на нативный перевод
