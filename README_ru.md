...
### Обновление 2.0.0
Версии v2 быть? И ещё какой...

В отличии от привычной нам Wunjo AI v1, новая версия будет именно версией, а не обновлением, что означает параллельное развитие v1 и v2.

Тогда как v1 имеет концепцию создания просто и доступного для понимания приложения, где дипфейки, синтез речи, итд. создаются в один клик с минимальным порогом входа и возможности использования приложения на своем сервере.

Версия v2 будет иметь концепцию профессионального редактора без ограничений на творчество. Где пользователь может создавать самостоятельно любые связки Node, сохранять их и загружать. 

Несколько скриншотов, демонстрирующих текущий прогресс разработки.
...
Чтобы получить более подробную информацию о ходе разработки Wunjo V2, присоединяйтесь к нашему сообществу в блоге [Telegram](https://t.me/s/wladblog). Следите за новостями!
...
Я выражаю нашу искреннюю благодарность следующим людям, которые щедро поддержали этот проект посредством пожертвований:
...
Я искренне ценю щедрость всех наших сторонников. Ваш вклад позволяет нам продолжать улучшать и поддерживать этот проект.
