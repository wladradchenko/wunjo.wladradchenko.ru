...
- [x] Добавлена автоматическая установка ffmpeg на Windows
- [x] Обучена модель для клонирования голоса на русский язык
- [x] Показывать пользователю, сколько места занимает на диске результат синтеза
...
Обновление 1.6.1
- [ ] Имитирование [эмоции](https://github.com/PlayVoice/whisper-vits-svc/tree/bigvgan-mix-v2/crepe) голосом и улучщение клонирование голоса
- [ ] Генерация музыки
