...
Обновление 1.5.0
- [x] Добавить перевод клонирования голоса с кодировщиками на английском, китайском, русском, испанском языках.
- [x] Добавить хранилище моделей для клонирования голоса на разные языки (или скачивать все модели по умолчанию)
- [x] Добавить модуль замены лица для дипфейка на видео/фото с одного фото
- [ ] Добавить улучшение качества лицо до HD или улучшение качества фона до HD на видео/фото пользователя без дипфейка
- [ ] Сделать версию, которая будет включать все расширения без загрузки расширений (убрать расширения для повышения безопасности приложения в виндовс)
- [x] Улучшение индикации и перевода текущего прогресса синтеза речи или дипфейка
- [x] Добавить вкл/выкл для отладки с консолью Python в приложении
- [x] Изменение перевода в реальном времени на нативный перевод
- [ ] Улучшить сообщение о том, что графический процессор недоступен для пользователя и как его установить
- [ ] Добавить модуль изменения эмоций лица на видео/фото

Обновление 1.6.0
- [ ] Добавить создание дипфейкового видео с помощью текстовых подсказок
- [ ] Изменение кадров AI-ретуши в видео с помощью пользовательского инструмента
