...
Также генерация текста в изображение, изменение изображения и создания новых частей для видео. <b>Управление рестайлингом?</b> Теперь вы можете менять предметы, пол и национальность человека не просто в один клик, но и заранее контролировать процесс. И для этого вам понадобится всего лишь 8 ГБ видеопамяти.
...
<b>Откройте списки, чтобы просмотреть подробную информацию о требованиях и примерах.</b>
...
<details>
<summary>2. Анимация лица из изображения</summary>
...
<details>
<summary>3. Анимация рта из видео</summary>
...
<details>
<summary>4. Замена лица по одному фото</summary>
...
<details>
<summary>5. Удаление объектов с видео</summary>
...
<details>
<summary>6. Автоматичесское получение масок объектов</summary>
...
<details>
<summary>7. Преобразование видео в видео по текстовой подсказке (Только на GPU)</summary>
